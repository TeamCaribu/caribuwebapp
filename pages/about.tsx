...
export default function Home() {
  return (
    <div style={{fontFamily : 'Arial, Helvetica, sans-serif'}}>
           ...
           justifyContent={'center'} maxHeight={'8vh'} marginTop={'8vh'}><h1>Meet The Team:</h1></Box>
      <Box component={'main'} display={'flex'} flexDirection={{xs: 'column', md: 'row'}} alignItems={'center'}
         ...
         <Box>
            <h1>Hi, I'm <span style={{color : '#EE4411'}}>{'Caribu'}</span>
      ...
      <Box component={'main'} display={'flex'} flexDirection={{xs: 'column', md: 'row'}} alignItems={'center'}
         ...
         <Box alt={'image of developer'} style={{background: `-webkit-linear-gradient(135deg, rgb(0,255,164), rgb(166,104,255))`}} component={'img'} src='CaribuLogo.png' width={{xs: '35vh', md: '40vh'}}
              ...
              borderRadius={'50%'} p={'0.75rem'} mb={{xs: '1rem', sm: 0}} mr={{xs: 0, md: '2rem'}}/>
         <Box>
            <h1>Hi, I'm <span style={{color : '#EE4411'}}>Jordan</span>
            </h1>
            <h2>I'm a software engineer.</h2>
            <Box component={'ul'} p={'0.8rem'}>
               testing
